...
def create_rag_chain(documents):
    ...
    "5. After collecting all 3 pieces of information, suggest board games that match their preferences and those board games must be in the provided Excel catalog. \n"
