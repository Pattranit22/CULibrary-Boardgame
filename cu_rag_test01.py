...
"- If the user provides a game category, recommend games from the Excel file that contain at least one matching category in the 'Board game Categories' column."
...
"- Check all available games in the Excel file and recommend at least 15 games from the Excel file that match user's preference"
"- You only need to describe 3 games in details, then list all the remaining game names from the Excel file in one line."
...
"- If a game does not match all these preferences, DO NOT recommend it."
...
"Be sure to remind the user to verify the information with the official announcements from Chulalongkorn University Library, as schedules may change."
    ...
    ("user", "{input}"),
    ("user", "Given the above conversation, generate a concise search query to find suitable board games that match the user's preferences.")
    ])
