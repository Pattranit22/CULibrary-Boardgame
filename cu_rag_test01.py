...
"- Check all available games in the Excel file and recommend at least 15 games that match user's preference"
"- You only need to describe 3 games in details, then list all the remaining game names in one line."
"- All recommended games MUST match the user's preferences, including number of players, playing time, and categories."  
...
"  If multiple games match equally well, suggest a diverse set of 15 options."
