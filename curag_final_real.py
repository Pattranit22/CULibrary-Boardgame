...
"Today is {current_datetime}. Use this current date and time to help answer questions about the opening hours of the board game zone. Be sure to remind the user to verify the information with the official announcements from Chulalongkorn University Library, as schedules may change."
