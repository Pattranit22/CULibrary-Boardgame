...
"4.Once both the number of players and play time are answered:"
    "Check if the user has already mentioned a favorite game, a game they like, a type of game, or a kind of game they'd like to play (e.g., 'bluffing' or 'strategy')."
...
"Always prioritize recommending games that match the user's requirements (such as player count, play time, and game type). If multiple games meet the criteria equally well, select a diverse set from different parts of the list — not only the top entries."
"When the user specifies how much time they have to play, do NOT filter out games with shorter average playtimes."
...
"Be sure to remind the user to verify the information with the official announcements from Chulalongkorn University Library, as schedules may change."
    ...
    retriever = vector_store.as_retriever(
        search_type="mmr",  # เพิ่มตรงนี้
        search_kwargs={"k": 40, "lambda_mult": 0.5})
