...
from cu_rag_test01 import load_data, create_rag_chain  # แก้ชื่อไฟล์ Python ด้านบนให้ตรง เช่น boardgame_rag.py
import asyncio
import nest_asyncio
...
with col2:
    ...
    if st.button("I'm looking for bluffing games for 4 players"):
        starter_question = "I'm looking for bluffing games for 4 players"
